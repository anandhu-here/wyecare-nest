...
* `nx g @simondotm/nx-firebase:function my-function --firebaseApp firebase-api` - Add a firebase function to this project

See the plugin [README](https://github.com/simondotm/nx-firebase/blob/main/README.md) for more information.

## Commands

* `nx run firebase-api:deploy` - Deploy this app to firebase
* `nx run firebase-api:serve` - Serve this app using the firebase emulator
* `nx run firebase-api:build` - Build all functions associated with this app
* `nx run firebase-api:test` - Test all functions associated with this app
* `nx run firebase-api:lint` - Lint all functions associated with this app
