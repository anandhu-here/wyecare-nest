...
import { useOrganizationsControllerUpdateMutation, useUsersControllerUpdateMutation } from '@/features/generatedApi'
import { apiHostname } from '@/config/api.config'
import { countries, countryPhoneCodes } from '@/app/data'
...
const ProfileTab = () => {
    ...
    const [updateOrg, { isLoading: updateOrgLoading }] = useOrganizationsControllerUpdateMutation()
        ...
        if (userState) {
            setAdminFormData({
                ...
                address: {
                    ...
                    countryCode: userState?.address?.countryCode || ""
                }
            })
        }

        if (currentOrganization) {
            console.log(currentOrganization, 'mmmm')
            setOrgFormData({
                name: currentOrganization?.name || "",
                category: currentOrganization?.category || "",
                ...
                address: {
                    ...
                    countryCode: currentOrganization?.address?.countryCode || ""
                }
            })
        }
    }, [userState])
    ...
    const handleSubmitOrgProfile = async (e) => {
        ...
        try {
            const result = await updateOrg({
                id: currentOrganization?.id as any,
                                        ...
                                        <CardContent className="space-y-4">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                <div className="space-y-2 md:col-span-1">
                                                    ...
                                                    <Select
                                                        disabled={!isEditingAdmin}
                                                        value={adminFormData.address?.countryCode}
                                                ...
                                                <div className="space-y-2 md:col-span-2">
                                                    ...
                                                    <Input
                                                        id="phone"
                                                        name="phone"
                                                        value={adminFormData.address?.phone}
                                                        onChange={handleAdminFormChange}
